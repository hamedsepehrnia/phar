...
DEFAULT_PHONE = '03131305741'
DEFAULT_ADDRESS = 'خیابان طیب، نرسیده به ورودی پمپ بنزین، ساختمان آفتاب.'
...
DEFAULT_ABOUT_PARAGRAPHS = [
    ...
    'داروخانه ما در اصفهان، خیابان طیب، نرسیده به ورودی پمپ بنزین، ساختمان آفتاب واقع شده و به صورت حضوری و آنلاین آماده ارائه خدمات به مشتریان است.',
